...
class FilterDataUpload:
    ...
    def __init__(self, unfiltered_csv, filtered_csv, data_type):
        ...
        self.default_sleep_import_sources = ['AutoSleep',
                                             'Zane’s Apple\xa0Watch']

        self.default_restinghr_import_sources = ['Zane’s Apple\xa0Watch']
    ...
    def filter_watch_data(self, import_source=None):
        """
        Filters only workout data from Apple Watch from Workout.csv and writes
        to Workout_Filtered.csv
        :return: None
        """
